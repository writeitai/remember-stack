...
# 1. Automatic resolution (uses ambient credentials from 'remember login' or REMEMBER_DATA_PLANE_URL)
...
> **Backwards Compatibility**: The class name `MemoryClient` remains fully supported as an alias for `RememberClient`.

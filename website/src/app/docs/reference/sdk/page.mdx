...
The official Remember Python SDK provides a typed, lightweight client for interacting with Remember Cloud or self-hosted Remember engine deployments. Which surface to start with: [Choose your path](/docs/getting-started/choose-your-path).
...
envelope = client.facts_context(
    query="What database do we use for the memory store?",

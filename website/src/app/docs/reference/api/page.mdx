...
reports exact returned/total counts for both stances. It accepts only explicit
entity IDs, not names or a hidden resolution step; facts with no live evidence
are never returned.

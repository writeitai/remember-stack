...
Cypher return **`QueryResult/v1`**. The three assured operations return the D49
**envelope**. No query endpoint calls an LLM, and
...
typed D49 envelope where that contract adds value; reusable query patterns

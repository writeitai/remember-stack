...
neighbors; use the live SQL graph helpers or the saved
...
Server-owned one- and two-hop neighborhoods execute fixed SQL/PGQ patterns;
deeper neighborhoods and shortest-tier paths execute bounded recursive SQL

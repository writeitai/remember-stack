...
| `mime` | Media type. Defaults to a guess from the file name, then `application/octet-stream`. The engine converts only media types it has a converter for; see [File formats and converters](/docs/self-hosting/converters). |

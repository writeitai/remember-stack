...
| Control-plane token | `Authorization: Bearer umc_cp_…` | Only the routes marked **cp**; see [Tokens and sign-in](/docs/cloud/tokens-and-sign-in#control-plane-tokens) |
...
These routes implement the OAuth 2.0 device authorization flow for
deployment and control-plane tokens.

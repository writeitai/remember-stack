...
| `mime` | string | no | 1–255 characters. The engine processes only media types it has a converter for; see [File formats and converters](/docs/self-hosting/converters). |
...
[The pipeline and readiness](/docs/concepts/pipeline).

...
| --- | --- |
| Fact grain (`current_context`, `facts_current`) | Current facts + current-testimony support markers |
| Evidence grain default | Current testimony only |
| Historical assertion recipes (`claims_as_of`, etc.) | Full testimony history by design |

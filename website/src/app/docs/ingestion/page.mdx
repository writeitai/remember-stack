...
| **P1/P2/P3** | Spine | Search indexes, graph snapshot, corpus FS | No on query; rebuild workers |
...
- **P2 / P3** are whole-corpus publications (Compose: operations profile).
...
2. Prefer `current_context` / `facts_current` for “what do we know now?”
3. Use `question_context` / claims for “what sources said.”

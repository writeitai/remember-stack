...
input hashes skip embedding. Normal deletion/reconciliation and hard-forget use
the same refresh seam; if no supported fact remains, every profile cache field
clears together.

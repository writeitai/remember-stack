...
**Shipped smoke profile:** registers `text/markdown` and `text/plain` → Markdown passthrough. Unregistered MIME types never reach this stage: ingest refuses them, before raw storage and before a version exists (see [Troubleshooting](/docs/troubleshooting)).

...
when present and otherwise `published_at`. A relative phrase such as “three
hours ago” is resolved against that instant. The original phrase stays in
claim text; resolved dates belong in the structured validity fields.

...
- Current protocol is `RS-LoCoMo-Full-v34`, versioned and fingerprinted in the adapter README.
...
The D124 answer-only runner can reuse one processed Full-v34 sample across four

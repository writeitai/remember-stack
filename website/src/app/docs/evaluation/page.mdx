...
- Current protocol is `RS-LoCoMo-Full-v36`, versioned and fingerprinted in the adapter README.
...
The D124 answer-only runner can reuse one processed Full-v36 sample across four

...
- Answer agent can use the **complete shipped read plane**: assured operations,
  direct primitives, open SQL/Cypher and saved queries, P1/P2, and the ordinary
  published P3 mount. It has no private database/object-store shortcut.
- Readiness is **machine-verified** before answer; graph/corpus projections must be published when required.  

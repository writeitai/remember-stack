...
- Current protocol is `RS-LoCoMo-Full-v32`, versioned and fingerprinted in the adapter README.
...
The D124 answer-only runner can reuse one processed Full-v32 sample across four

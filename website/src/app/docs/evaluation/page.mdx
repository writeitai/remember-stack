...
- Current protocol is `RS-LoCoMo-Full-v35`, versioned and fingerprinted in the adapter README.
...
The D124 answer-only runner can reuse one processed Full-v35 sample across four

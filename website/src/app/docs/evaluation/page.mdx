...
- Current protocol is `RS-LoCoMo-Full-v37`, versioned and fingerprinted in the adapter README.
...
The D124 answer-only runner can reuse one processed Full-v37 sample across four

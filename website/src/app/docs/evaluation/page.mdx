...
- Current protocol is `RS-LoCoMo-Full-v31`, versioned and fingerprinted in the adapter README.
...
The D124 answer-only runner can reuse one processed Full-v31 sample across four

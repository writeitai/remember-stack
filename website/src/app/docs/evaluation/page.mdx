...
- Current protocol is `RS-LoCoMo-Full-v33`, versioned and fingerprinted in the adapter README.
...
The D124 answer-only runner can reuse one processed Full-v33 sample across four

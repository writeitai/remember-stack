...
Apache-2.0. Correctness-determining behavior — extraction, entity resolution, supersession, provenance, budgets, DLQ, hard-forget — is **never paywalled**. The hosted cloud runs this same engine; it adds operations and product chrome, not a secret core. Self-host gets the complete memory for one deployment.
...
- [remember.db architecture](/docs/architecture) — the durable spine and how reads and writes relate.

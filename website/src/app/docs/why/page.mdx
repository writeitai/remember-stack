export const metadata = {
  title: "Why this memory",
  description:
    "What RememberStack memory is and why agents that act need it: testimony vs truth, failure modes vs passage RAG, and a harder question than similar text.",
};
...
## Indexes nominate; the spine confirms
...
- [Architecture](/docs/architecture) — the durable spine and how reads and writes relate.

...
A document that was still being processed when you deleted it finishes
processing, but nothing it produces becomes visible: it is retired when its
version reaches the `reconcile` stage. Details and errors:

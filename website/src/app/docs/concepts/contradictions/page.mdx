...
the same time. During [adjudication](/docs/concepts/facts#how-a-claim-changes-the-facts)
...
and stops matching `current` queries. See [Time](/docs/concepts/time).
...
- [Facts](/docs/concepts/facts): the adjudication decisions behind all three cases.
- [Evidence](/docs/concepts/evidence): the claims on each side.
- [Reading a result](/docs/concepts/reading-results): `contradiction`,

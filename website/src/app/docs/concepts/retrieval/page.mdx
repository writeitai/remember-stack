...
| [MCP](/docs/reference/mcp) (`remember mcp`, or the hosted server on remember.dev) | A coding agent such as Claude Code or Codex. | Ingest, readiness and the four operations; `remember mcp` also has the seven SQL query tools. No primitives. |

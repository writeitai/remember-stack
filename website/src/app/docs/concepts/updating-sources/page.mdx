...
only when the source acts, or when its document is deleted. See [Facts](/docs/concepts/facts#support-withdrawn).
...
[Documents, versions and sources](/docs/concepts/documents-and-sources#re-ingesting-the-same-bytes-createdfalse).
...
- [Keep a source up to date](/docs/guides/keep-sources-current): a working
  sync loop.
- [Claims](/docs/concepts/claims#current-and-superseded-testimony): testimony currency.
- [Contradictions](/docs/concepts/contradictions): what a changed value does to facts.

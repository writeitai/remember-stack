...
case, reaches T4. When T4 says a same-name mention is a different referent, the
registry mints another id with that spelling and stores the non-match as a
durable exclusion so later clustering cannot glue the pair back together.

...
Token audiences and where memory answers: [How Remember Cloud works](/docs/cloud/how-it-works).
...
- Re-adjudicates affected entity relations in the bitemporal store, closing valid-time intervals or removing facts that have no surviving provenance (E3).

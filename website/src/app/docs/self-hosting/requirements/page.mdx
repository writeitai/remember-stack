...
|---|---|---|
| `ghcr.io/writeitai/remember-stack:0.17.1` (API and workers) | Pulled from GitHub Container Registry; Compose can also build it from `Dockerfile` | **linux/amd64 only** |

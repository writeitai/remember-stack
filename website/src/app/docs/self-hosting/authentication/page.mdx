...
remember.dev deployments also bill through a spend lease: with the
metering variables set, the API refuses to start unless
`REMEMBERSTACK_SELFHOST_SPEND_LEASE_URL` points at the billing service.

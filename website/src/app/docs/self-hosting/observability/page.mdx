...
`docker compose up -d`. The `setup`, `api` and worker<Cloud> and `meter-receipts`</Cloud>
...
remember.dev collects no traces, logs, metrics or error reports from your
deployment; see [Data handling and security](/docs/cloud/data-and-security#diagnostics).

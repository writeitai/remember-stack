...
The last command generates the database password and the object-store
credentials; `.env.example` ships none, and Compose refuses to start
without them.
...
[Requirements](/docs/self-hosting/requirements#docker-and-compose)). To serve other machines,

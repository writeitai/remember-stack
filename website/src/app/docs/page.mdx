...
> **Status: pre-release.** Phases 0–7 are implemented, and [`v0.2.0`](https://github.com/writeitai/remember-stack/releases/tag/v0.2.0) is installable from [PyPI](https://pypi.org/project/rememberstack/0.2.0/) or as a public [GHCR container](https://github.com/writeitai/remember-stack/pkgs/container/remember-stack). Interfaces and the data model may still change before a stable release. The [public roadmap](https://github.com/writeitai/remember-stack/blob/main/plan/plans/roadmap.md) and [Project Status](/docs/project-status) page track what exists and what comes next.

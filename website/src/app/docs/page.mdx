...
The default self-host profile routes **Markdown** conversion out of the box; additional MIME routes (HTML/PDF/media) are engine-supported but must be registered on the deployment. See [Project status](/docs/project-status) for what ships.

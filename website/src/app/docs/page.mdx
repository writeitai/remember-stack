...
| `testimony_context` | High-recall **evidence** context (claims + chunks) for a question |
| `fact_context` | **Current or historical fact** context with live testimony under budget |

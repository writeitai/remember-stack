...
Deployment-rendered **consumption skill** teaches the two-layer model and S58-tested curriculum. See [Mounts and skill](/docs/mounts).
...
## Where binding detail lives

This site documents **what ships**. Full-scope design, decisions, and evals live in the repository:

- [`plan/designs/overall_design.md`](https://github.com/writeitai/remember-stack/blob/main/plan/designs/overall_design.md)
- [`decisions.md`](https://github.com/writeitai/remember-stack/blob/main/decisions.md)
- Per-plane designs under [`plan/designs/`](https://github.com/writeitai/remember-stack/tree/main/plan/designs)

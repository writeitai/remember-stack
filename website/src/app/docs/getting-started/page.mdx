...
The Compose file can also pull the public `ghcr.io/writeitai/remember-stack:0.7.0` image. Use `--build` when you want to run local source; use `--no-build --pull always` when you want the released image.

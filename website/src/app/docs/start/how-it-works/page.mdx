...
See [Documents, versions and sources](/docs/concepts/documents-and-sources).
...
![The stages a document passes through, from storing the file to being queryable.](/docs/diagrams/pipeline.svg)
...
![From a fact back to the sentence in the source document.](/docs/diagrams/provenance.svg)

## Where to go next

- [Quickstart](/docs/start/quickstart): do this yourself.
- [Claims](/docs/concepts/claims), [Facts](/docs/concepts/facts) and
  [Time](/docs/concepts/time): the ideas behind each step.
- [The pipeline and readiness](/docs/concepts/pipeline): every stage in
  detail.

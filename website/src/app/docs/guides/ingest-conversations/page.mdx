...
Setup (endpoint and token) is in the [Quickstart](/docs/start/quickstart).
...
ignored. [Keep a source up to date](/docs/guides/keep-sources-current) and [Updating
a source: snapshot and living](/docs/concepts/updating-sources) explain the
difference in full.
...
- [Ask about the past](/docs/guides/ask-about-the-past): questions like "what did we

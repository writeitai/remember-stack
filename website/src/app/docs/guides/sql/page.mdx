...
Setup is in the [Quickstart](/docs/start/quickstart). The full list of
views and columns is in [Query space memory_v1](/docs/reference/query-space).
...
queries](/docs/guides/saved-queries).
...
memory_v1](/docs/reference/query-space).
...
- [Saved queries](/docs/guides/saved-queries): the 18 shipped queries to start from.
- [Query space memory_v1](/docs/reference/query-space)
- [SQL query routes in the HTTP API](/docs/reference/http-api/query)

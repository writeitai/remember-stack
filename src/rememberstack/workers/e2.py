...
specific antecedent established within the supplied bundle
(e.g., "her third screenplay"), rather than degrading into a vague generic noun like "a story".
Merely answering a question without affirming its premise does not license
binding. If the speaker corrects or negates the question (for example, "No,
that's actually my fourth"), extract the speaker's corrected assertion ("her
fourth screenplay"), never the premise of the rejected question. If the speaker
deflects, hedges, or expresses uncertainty ("Not sure yet", "Maybe someday"),
do not bind the question's premise as an established fact. If the dialogue leaves
multiple competing referents plausible, omit that candidate. Cite every supplied
passage needed to establish the complete evidence chain (origin turn, preceding
question turn, and work kind origin) in source_refs.

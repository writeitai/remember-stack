...
EXPECTED_TABLES: Final = (
    ...
    "temporal_artifact_certificates",
    "temporal_artifact_dependencies",
    "temporal_blocks",
    "temporal_checkpoint_blocks",
    "temporal_checkpoint_components",
    "temporal_checkpoint_facts",
    "temporal_conversion_rows",
    "temporal_conversion_runs",
    "temporal_discrepancies",
    "temporal_fact_generations",
    "temporal_forget_checkpoints",
    "temporal_operation_blocks",
    "temporal_operation_dependencies",
    "temporal_operation_evidence",
    "temporal_operation_support",
    "temporal_operations",
    "temporal_source_members",
    "temporal_sources",
    "aliases",
    "canary_cases",
    "chunk_claims",
...
EXPECTED_INDEXES: Final = (
    ...
    "ix_rel_flush_units_block",
    "ix_temporal_certificate_expiry",
    "ix_temporal_checkpoint_block",
    "ix_temporal_checkpoint_fact",
    "ix_temporal_checkpoint_seed",
    "ix_temporal_conversion_progress",
    "ix_temporal_dependencies_source",
    "ix_temporal_event_artifact",
    "ix_temporal_event_boundary",
    "ix_temporal_event_source",
    "ix_temporal_evidence_claim",
    "ix_temporal_members_activation",
    "ix_temporal_members_expiry",
    "ix_temporal_members_fact",
    "ix_temporal_operations_observation",
    "ix_temporal_operations_relation",
    "ix_temporal_sources_next",
    "uq_rel_active_batch",
    "uq_temporal_artifact_event",
    "uq_temporal_page_certificate",
    "uq_temporal_profile_certificate",
    "uq_temporal_source_event",
    "ux_observation_adjudication_temporal_operation",
    "ux_relation_adjudication_temporal_operation",
    "ux_temporal_discrepancy_observation",
    "ux_temporal_discrepancy_relation",
    "ix_adjud_live",
    "ix_adjud_relation",
    "ix_aliases_entity",
    "ix_aliases_lemma_dm",

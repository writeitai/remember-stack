...
VIEW_CONTRACTS: Final = (
    ...
    ViewContract(
        name="claims_canonical",
        grain=(
            "one historically visible claim with surviving lineage and its"
            " half-open canonical window"
        ),
        grain_tag="claim_visible_history_canonical",
        clock_semantics="claim_validity_immutable",
        row_key=("deployment_id", "claim_id"),
        join_keys=(
            JoinKey(
        ...
        indexes_used=("ix_claims_doc", "ix_claims_chunk", "ix_claims_canonical_window"),

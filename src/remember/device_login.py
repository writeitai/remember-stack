...
DeviceAuthorization = DeviceAuthorizeResponse
...
DeviceTokenError = DeviceTokenErrorBody
...
def credential_from_token(
    *,
    ...
    proj_map[active_proj_id] = ProjectCredentials(
        ...
        data_plane_url=api_url,
        data_plane_token=token.access_token,
    ...
    return CredentialFile(
        ...
        projects=proj_map,
        control_plane=existing.control_plane if existing else None,
    )

...
stages completed, the live graph is ready, and P3 is fresh. Reusing one deployment across samples
...
The driver itself freezes the complete non-secret V17 ingest identity before
...
| `LOCOMO_PROTOCOL` | `full-v17` | prepare-time protocol key |

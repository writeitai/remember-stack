"""Typed values for the full-system RS-LoCoMo-Full-v18 protocol."""
...
ProtocolKey = Literal["full-v18"]
ProtocolName = Literal["RS-LoCoMo-Full-v18"]
...
class RunConfiguration(FrozenModel):
    ...
    protocol_name: ProtocolName = "RS-LoCoMo-Full-v18"

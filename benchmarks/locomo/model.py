"""Typed values for the full-system RS-LoCoMo-Full-v17 protocol."""
...
ProtocolKey = Literal["full-v17"]
ProtocolName = Literal["RS-LoCoMo-Full-v17"]
...
class RunConfiguration(FrozenModel):
    ...
    protocol_name: ProtocolName = "RS-LoCoMo-Full-v17"

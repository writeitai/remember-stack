...
PROTOCOL_NAME: Final = "RS-LoCoMo-Full-v34"
DEFAULT_PROTOCOL_KEY: Final = "full-v34"
ADAPTER_VERSION: Final = "locomo-full-adapter-2026.09-document-context-v34"
"""Adapter identity for Full-v34: v33 pins plus T4 and fact output-format prompts."""
...
EXPECTED_INGEST_COMPONENT_VERSIONS: Final[Mapping[str, str]] = MappingProxyType(
    {
        ...
        "normalize_relations": (
            ...
            "assertion-clarity-3:d123-context-refs-2:both-lists-1:t4-format-1"
        ),
        "adjudicate_observations": (
            ...
            "both-lists-1:t4-format-1:relation-adjudicator-2026.09d:"
            "concise-handles-5:d123-context-nom-2:output-fields-1:"
...
GEMMA_VERTEX_PROTOCOL_NAME: Final = "RS-LoCoMo-Full-v34-GemmaVertex"
GEMMA_VERTEX_PROTOCOL_KEY: Final = "full-v34-gemma-vertex"
...
The variant is reader-only. It keeps every canonical v34 ingest pin --
...
"""
CODEX_SUBSCRIPTION_PROTOCOL_NAME: Final = "RS-LoCoMo-Full-v34-CodexSubscription"
CODEX_SUBSCRIPTION_PROTOCOL_KEY: Final = "full-v34-codex-subscription"

...
Each returns an [`Envelope`](../result-types.md#envelope).
...
The assured operation [`resolve_entity`](../assured-operations.md#resolve_entity)
...
[`FactResult`](../result-types.md#factresult) per relation (`kind:
...
| `500` | `Internal Server Error` | `valid_at` has a non-UTC offset (see the warning in [Result types](../result-types.md#timestamps)). |
...
- `evidence`: the supporting claims
  ([`EvidenceResult`](../result-types.md#evidenceresult)), each with its source
  span and character offsets.
- `sources`: the documents
  ([`SourceRecord`](../result-types.md#sourcerecord)).
...
most recent decisions ([`TranscriptEntry`](../result-types.md#transcriptentry)),

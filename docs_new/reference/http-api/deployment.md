...
are described in [HTTP API conventions](index.md).
...
`200` with a [`DeploymentBuildInfo`](../result-types.md#deploymentbuildinfo):
...
[`PipelineReadinessReport`](../result-types.md#pipelinereadinessreport).
...
to start without it. See [Observability](../../self-hosting/observability.md).

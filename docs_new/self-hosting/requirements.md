...
later one. See [Upgrades and migrations](upgrades.md).
...
checks these three versions (see [Operating the pipeline](operating.md)).
...
[Scaling](scaling.md) explains each bound and how to change it.

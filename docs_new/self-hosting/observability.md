...
[Operating the pipeline](operating.md#inspect-the-pipeline).
...
([Configuration](configuration.md#what-compose-passes-through)) and publish
...
Settings; see [Data handling and security](../cloud/data-and-security.md).

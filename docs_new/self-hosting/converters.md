...
!!! warning
    ...
    override file described in [Configuration](configuration.md#what-compose-passes-through);
...
calls. [Readiness](../guides/wait-for-readiness.md) shows the version's
...
covers; the rest stays parked. See [Operating the pipeline](operating.md).
...
[Limits](../cloud/limits.md) for the formats and sizes it accepts.

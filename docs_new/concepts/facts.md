...
them from the entities you ask about. See [Retrieval](retrieval.md).
...
`evidence_count`. See [Reading a result](reading-results.md).
...
[Entities](entities.md)), and each assertion is then **adjudicated** against
...
`transcript_relation` (see [Evidence](evidence.md#why-do-we-believe-this)).
...
the same writer. See [Models and providers](../self-hosting/models.md).
...
- [Time](time.md): the window every fact carries and how to query it.
- [Contradictions](contradictions.md): what happens when facts disagree.
- [Entities](entities.md): what a fact is about.
- [Assured operations](../reference/assured-operations.md): `facts_context`.

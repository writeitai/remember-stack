...
=== "remember.dev"
    ...
    **Cursor**: add to `.cursor/mcp.json` in your project:
    ...
    on [Hosted MCP](../cloud/hosted-mcp.md).
...
=== "Self-hosted"
    ...
    Add `--dry-run` to see what it would write, and `--url` if your engine
    ...
    in the [MCP reference](../reference/mcp.md).

## What the agent can do

With the self-hosted server the agent gets these tools:
...
[Hosted MCP](../cloud/hosted-mcp.md) for its exact list.
...
- [Give an agent context](../guides/agent-context.md): which operation fits
  which question.

...
benchmark-specific claim-search shortcut. Use the named protocol **`RS-LoCoMo-Full-v4`**:
...
`known_empty` when no K page exists, but `RS-LoCoMo-Full-v4` must not claim that K synthesis was

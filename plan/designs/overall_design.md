...
| `registries_design.md` | entity resolution, ontology, governance, review, eval (D15–D24); identity/T0/type **amended** D95–D96 | **current** (see identity design) |
| `entity_identity_and_retrieval_design.md` | referent identity, optional hats, default retrieval (D95–D97) | **current** |

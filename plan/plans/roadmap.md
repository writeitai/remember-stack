...
| 8 | Competitive benchmarks | external benchmark harness, adapters, OSS baselines (Mem0/Graphiti), capability benchmark, published methodology + results | D22 (internal) + D78 + `phase-8` survey | in progress (WP-8.1 done; WP-8.2 LoCoMo; WP-8.7b Mem2Act Track B setup landed per D81) |

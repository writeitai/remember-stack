...
For the temporal program, start with [D114 mutable fact windows](designs/mutable_fact_windows_design.md)
...
superseded by D114's explicit authority map. Their documents and SQL remain

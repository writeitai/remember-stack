...
| [`../../plan/analysis/locomo_direct_answer_completeness_analysis.md`](../../plan/analysis/locomo_direct_answer_completeness_analysis.md) | Full-v19 conv-26 replay, its fixed counterfactual, the new incomplete direct-answer miss, and the prompt-only Full-v20 response. Analysis, not binding design. |
